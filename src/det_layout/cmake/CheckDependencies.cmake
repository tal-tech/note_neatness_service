...
function(detect_protobuf)
  ...
  if (WIN32)
    ...
    if (PROTOBUF_FOUND)
      ...
      file(GLOB PROTOBUF_COMPILER /usr/bin/protoc)
    endif()
  endif()
...
function(detect_tensorflow)
  ...
  if (WIN32)
	...
	if (CPU_ONLY)
        set(TENSORFLOW_INCLUDE ${PROJECT_SOURCE_DIR}/../3rdParty/tensorflow/r1.8/include)
    else()
	    set(TENSORFLOW_INCLUDE ${PROJECT_SOURCE_DIR}/../3rdParty/tensorflow/r1.8/include)
	endif()
	
    if (CPU_ONLY)
      file(GLOB TENSORFLOW_LIBRARY ${PROJECT_SOURCE_DIR}/../3rdParty/tensorflow/r1.8/libs/Win64/cpu/*.lib)
    else()
      file(GLOB TENSORFLOW_LIBRARY ${PROJECT_SOURCE_DIR}/../3rdParty/tensorflow/r1.8/libs/Win64/cuda9/*.lib)
    endif()
  else()
    set(HAVE_TENSORFLOW TRUE)
    set(TENSORFLOW_INCLUDE ${PROJECT_SOURCE_DIR}/../3rdParty/tensorflow/r1.8/include)
    ...
    if (CPU_ONLY)
      file(GLOB TENSORFLOW_LIBRARY ${PROJECT_SOURCE_DIR}/../3rdParty/tensorflow/r1.8/libs/Linux/cpu/*.so)
    else()
      file(GLOB TENSORFLOW_LIBRARY ${PROJECT_SOURCE_DIR}/../3rdParty/tensorflow/r1.8/libs/Linux/cuda9/*.so)
    endif()
  endif()

  if (HAVE_TENSORFLOW)
    message(STATUS "Found TENSORFLOW: found (include: ${TENSORFLOW_INCLUDE}, library: ${TENSORFLOW_LIBRARY})")
    set(HAVE_TENSORFLOW    ${HAVE_TENSORFLOW}  PARENT_SCOPE )
    set(TENSORFLOW_INCLUDE ${TENSORFLOW_INCLUDE} PARENT_SCOPE)
    set(TENSORFLOW_LIBRARY ${TENSORFLOW_LIBRARY} PARENT_SCOPE)
  endif()
...
function(detect_all)
  ...
  # detect_tensorflow()
  # if (HAVE_TENSORFLOW)
  #   list(APPEND PROJECT_INCLUDE ${TENSORFLOW_INCLUDE})
  #   list(APPEND PROJECT_LIBRARY ${TENSORFLOW_LIBRARY})
  # endif()
