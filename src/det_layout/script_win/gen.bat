...
xcopy data\models\%modelname% release\%rfloder%\model\ /y
xcopy data\config.ini release\%rfloder%\model\ /y
xcopy data\images release\%rfloder%\images\testing\ /d /e /y
...
xcopy ..\3rdParty\tensorflow\r1.8\libs\Win64\cuda9\tensorflow.dll release\%rfloder%\libs\x64\gpu\ /y
xcopy ..\3rdParty\tensorflow\r1.8\libs\Win64\cpu\tensorflow.dll release\%rfloder%\libs\x64\cpu\ /y
