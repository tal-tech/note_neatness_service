...
from ctpn_utils.text_connector.other import Graph
from ctpn_utils.text_connector.text_connect_cfg import Config as TextLineCfg
...
class TextProposalGraphBuilder:
    ...
    """
    def __init__(self):
        self.boxes_table = [[] for _ in range(3000)]
    ...
    def build_graph(self, text_proposals, scores, im_size):
        ...
        for i in range(self.im_size[1]) :
            self.boxes_table[i] = []

        for index, box in enumerate(text_proposals):
            self.boxes_table[int(box[0])].append(index)
